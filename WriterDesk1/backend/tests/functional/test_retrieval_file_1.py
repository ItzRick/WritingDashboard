...
def testRetrieveFilesOfUserDateAsc(testClient, initDatabaseEmpty):
    '''
...
def testRetrieveFilesOfUserDateDesc(testClient, initDatabaseEmpty):
    '''
        This test checks the retrieval of of files in a specified order, namely
...
def testRetrieveFilesOfUserFilenameAsc(testClient, initDatabaseEmpty):
    '''
        This test checks the retrieval of of files in a specified order, namely
...
def testRetrieveFilesOfUserFilenameDesc(testClient, initDatabaseEmpty):
    '''
        This test checks the retrieval of of files in a specified order, namely
