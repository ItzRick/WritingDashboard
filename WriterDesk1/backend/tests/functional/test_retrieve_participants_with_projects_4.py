...
def testRetrieveMultipleProjectMultipleParticipantsOfUserWithOther(testClient, initDatabase): 
    '''
        ...
        Attributes: 
            ...
            participant8: new user
            project1: new project
            project2: new project
            project3: new project
            project4: new project
            connection: connection between project1 and participant1
            connection3: connection between project3 and participant4
            connection4: connection between project2 and participant5
            connection5: connection between project2 and participant6
            connection6: connection between project4 and participant7
            connection7: connection between project4 and participant8
...
def testRetrieveMultipleProjectMultipleParticipantsOfUserWithOther(testClient, initDatabase): 
    '''
        ...
        Attributes: 
            ...
            project4: new project
            connection: connection between project1 and participant1
            connection6: connection between project1 and participant2
            connection7: connection between project3 and participant3
            connection3: connection between project3 and participant4
            connection4: connection between project2 and participant5
            connection5: connection between project2 and participant6
            connection6: connection between project4 and participant7
