...
def testRetrieveSingleProjectSingleParticipantOfUserWithOther(testClient, initDatabase): 
    '''
        ...
        Attributes: 
            ...
            project1: new project of researcher1
            project2: new project of researcher2
            participant1: new participant
            participant2: new participant
            participant3: new participant
            connection: connection between participant1 and project1
            connection1: connection between participant2 and project2
            connection2: connection between participant3 and project2
