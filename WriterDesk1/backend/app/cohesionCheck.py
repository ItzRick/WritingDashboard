...
def generateExplanation(text):
    ...
    # used words (if there are less than three then that many).
    if TTRScore >= 9:
        TTRScoreExplanation = ("The amount of variation of words you use is "
            "very good.")
    elif TTRScore >= 7:
        TTRScoreExplanation = ("You used enough variation of words, however "
            "you could improve this some more. These are your most used "
            "words: "+ mostCommonFeedback)
    elif TTRScore >= 5:
        TTRScoreExplanation = ("You barely have enough variation of words, "
            "you should improve on this. These are your most used words:"
            " " + mostCommonFeedback)
    else: 
        TTRScoreExplanation = ("You did not use enough variation in terms of "
            "words, you are using the same words too much. These are your "
            "most used words: " + mostCommonFeedback)
    ...
    if connectivesScore >= 9:
        ...
        if indexScore < 0.09:
            connectivesScoreExplanation = ("You could use some more "
