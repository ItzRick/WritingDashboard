...
const Settings = () => {
    ...
    */   
    ...
    const deleteUser = () => {
        //   The backend url:
        const url = 'https://localhost:5000/usersapi/deleteUserSelf';
    ...
    const changePassword = () => {
        ...
        axios.post(`https://localhost:5000/loginapi/setPassword`, data, {headers: authHeader()}).then(response =>{
    ...
    const handleOwnUserData = () => {
        const url = 'https://localhost:5000/clickapi/getOwnUserData';
    ...
    const changeEmail = () => {
        ...
        axios.post(`https://localhost:5000/loginapi/setUsername`, data, {headers: authHeader()})
        .then(response =>{
            // Set a success message, reset the field.
