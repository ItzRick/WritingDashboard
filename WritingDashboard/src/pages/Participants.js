      ...
      renderCell: (params) => {
        ...
        return (<div>
          <Tooltip title="View the documents of this participant.">
            <IconButton id={'documents' + params.rows.username} onClick={(e) => { navigateToPartDoc(e, params) }} ><FormatAlignJustify /></IconButton>
          </Tooltip>
          <Tooltip title="Delete this participant.">
            <IconButton id={'delete' + params.rows.username} onClick={(e) => { showdeleteProjectDialog(e, params) }}><DeleteOutline /></IconButton>
          </Tooltip>
          </div>);
      }
    }
