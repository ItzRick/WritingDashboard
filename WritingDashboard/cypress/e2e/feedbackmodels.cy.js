describe('Test the feedback models page', () => {
    ...
    it('Checks if all elements are present.', () => {
        cy.contains('To change the feedback model, go to')
        cy.contains('https://github.com/ItzRick/WritingDashboard')
        cy.contains(', create a new branch and change the code there. To change the feedback model, ' +
            ...
            'all feeedback of the reviewer.')
        cy.contains('The current feedback model version is: 0.01.')
    })
